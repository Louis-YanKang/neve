...
OPTFLAGS = -O3 -DPRINT_DIST_STATS -DPRINT_EXTRA_NEDGES #-DUSE_OMP_ACCELERATOR
...
CXXFLAGS_THREADS = -fopenmp -DUSE_SHARED_MEMORY -DGRAPH_FT_LOAD=4 -DNTIMES=1 #-DEDGE_AS_VERTEX_PAIR #-DENABLE_PREFETCH 
CXXFLAGS_MPI = 
